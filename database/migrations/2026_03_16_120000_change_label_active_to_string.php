...
return new class extends Migration
{
    ...
    {
        // Eerst bestaande string waarden omzetten naar booleans
        DB::table('labels')->where('label_active', 'ja')->update(['label_active' => true]);
        DB::table('labels')->where('label_active', 'nee')->update(['label_active' => false]);
